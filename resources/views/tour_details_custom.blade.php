...
@section('content')
    <div class="maincont whitebg">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <span class="price {{$currency['currency']}}">
            	        <span class="{{$currency['currency']}}">{{round($hotels[0]['single_adult']/$currency[$currency['currency']])}}</span>
        ...
        <div class="container" id="many_adults_form">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="feedback">
                        <h2>Feedback Form</h2>
                        <div class="hint">Please contact to the agent in case if travelers more then 4 adults.</div>
                        <form>
                        ...
                        <div class="choosehotel @if($key == 0) selected @endif">
                            ...
                            <div class="hotels-r">
                                ...
                                <span class="maincurrency" data-toggle="tooltip" data-placement="top"
                                      title="
                                        @foreach($currency  as $key => $value)
                                            @if(($key !== 'currency') && ($key !== $currency['currency'])){!! (round($hotel['single_adult']/$value, 2))*count($days).'/'!!}
                                        @endif
                                    @endforeach
                                    "><span class="{{$currency['currency']}}">{{(round($hotel['single_adult']/$currency[$currency['currency']], 2))*count($days)}}</span></span>
                                </div>
                            </div>
                            <div class="clear"></div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12 day-sep">
                        ...
                        <div class="tour-description">
                            <p>
                                The Khor Virap is an Armenian monastery located in the Ararat plain in Armenia, near the
                ...
                <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12 day-sep">
                        ...
                        <div class="tour-description">
                            <p>
                                Wings of Tatev is a 5.7 km (3.5 mi) cableway between Halidzor and the Tatev monastery in
                                Armenia. It is the longest reversible aerial tramway built in only one section, and
                                holds the record for Longest non-stop double track cable car. Construction was finished
                                on 16 October 2010.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-11 col-sm-11 col-xs-12 day-sep">
                        ...
                        <div class="tour-description">
                            <p>
                                The tour starts at 7am early in the morning. You will have breakfast on the road. The
                                first stop is Khor Virap, which is the closest place to mount Ararat. You will then
                                continue to Areni wine factory where you can enjoy wine tasting. After tasting why not
