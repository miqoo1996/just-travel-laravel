                        ...
                        <div class="form-horizontal form-label-left">
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Page URL" name="page_url" value="{{$page->page_url}}">
                                </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="myTabContent" class="tab-content">
                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_title no_border">
                                <h2>Page Name<small>(English Version)</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <input type="text" class="form-control input-lg" placeholder="Page Name" name="page_name_en" value="{{$page->page_name_en}}">

                            <br />

                            <div class="x_title no_border">
                                <h2>Tour Description<small>(English Version)</small></h2>
                                <div class="clearfix"></div>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_title no_border">
                                <h2>Page Name<small>(Russian Version)</small></h2>
                                <div class="clearfix"></div>
                            </div>
                            <input type="text" class="form-control input-lg" placeholder="Page Name" name="page_name_ru" value="{{$page->page_name_ru}}">

                            <br />

                            <div class="x_title no_border">
                                <h2>Tour Description<small>(Russian Version)</small></h2>
                                <div class="clearfix"></div>
                            </div>
            ...
            <div class="x_panel">
                <div class="x_content">
                    ...
                    <div class="checkbox-custom">
                        <label>
                            <input type="checkbox" class="flat" name="visibility"> Visible on the site
                        </label>
                    </div>
