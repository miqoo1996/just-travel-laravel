                            ...
                            <div class="margin-b-10 custom-field">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 margin-b-10">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9 col-xs-12 margin-b-10 col-md-offset-3 col-sm-offset-3">                                                    <textarea
                                                    class="resizable_textarea form-control" placeholder="description"
                                                    name="custom_day_desc_ru[]"></textarea>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
