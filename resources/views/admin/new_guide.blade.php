                                ...
                                <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="guide_name_en" required="required" name="guide_name_en" class="form-control col-md-7 col-xs-12" placeholder="Guide Name (English)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="x_content">
                                <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="guide_name_ru" name="guide_name_ru" required="required" class="form-control col-md-7 col-xs-12" placeholder="Guide Name (Russian)">
                                        </div>
                                    </div>
                                </div>
                            </div>
