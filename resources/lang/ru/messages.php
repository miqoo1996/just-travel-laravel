...
return [
	...
	'ErrorCode.2' => 'Заказ отклонен по причине ошибки в реквизитах платежа',
	'ErrorCode.5' => 'Ошибка значения параметра запроса',
	'ErrorCode.6' => 'Незарегистрированный OrderId',
    'OrderStatus.0' => 'Заказ зарегистрирован, но не оплачен',
    'OrderStatus.1' => 'Проведена предавторизация суммы заказа',
    'OrderStatus.2' => 'Проведена авторизация суммы заказаа',
    'OrderStatus.3' => 'Авторизация отменена',
    'OrderStatus.4' => 'По транзакции была проведена операция возврата',
